/** FILE: yy_2lateulerevolve.h                 -*-Mode: c++-*-
 *
...
#ifndef _YY_2LATEULEREVOLVE
#define _YY_2LATEULEREVOLVE
...
class YY_2LatEulerEvolve:public YY_2LatTimeEvolver {
private:
...
public:
  ...
  YY_2LatEulerEvolve(const char* name,     // Child instance id
     Oxs_Director* newdtr, // App director
     const char* argstr);  // MIF input block parameters
  virtual ~YY_2LatEulerEvolve();
