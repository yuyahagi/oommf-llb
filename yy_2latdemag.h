...
#ifndef _YY_2LATDEMAG
#define _YY_2LATDEMAG
...
class YY_2LatDemag : public Oxs_Energy {

  friend class Oxs_FFTLocker;
  friend class _YY_2LatDemagFFTxThread;
  friend class _YY_2LatDemagiFFTxDotThread;
  friend class _YY_2LatDemagFFTyThread;
  friend class _YY_2LatDemagFFTyConvolveThread;
  friend class _YY_2LatDemagFFTzConvolveThread;
  friend class _YY_2LatDemagFFTyzConvolveThread;
public:
  ...
  public:
    ...
    /// YY_2LatDemag object gets a separate locker.
    /// See YY_2LatDemag member function MakeLockerName().
...
public:
  ...
  YY_2LatDemag(const char* name,     // Child instance id
	    Oxs_Director* newdtr, // App director
	    const char* argstr);  // MIF input block parameters
  virtual ~YY_2LatDemag();
